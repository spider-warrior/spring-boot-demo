...
public class UserGameData extends BaseModel {
	/** 体力兑换经验值系数 */
	public static final int ENERGY_TO_EMPIRIC_RATE = 20;
	/** 经验值对应等级的映射 **/
	public static final RangeMap<Integer, Integer> levelRangeMap = TreeRangeMap.create(); 
	/**
	 * userId
	 */
	@Indexed(sparse = true)
	 ...
	 * 上次消耗体力时间
	 */
	private long lastConsumeEnergyTime = 0;
	...
	public int getEmpiricLevel(){
		return levelRangeMap.get(this.getEmpiric());
	}
	 ...
	 * @return
	 */
	public static int reckonEnergyToEmpiric(int energy){
		return energy * ENERGY_TO_EMPIRIC_RATE;
	}
	...
	public static void main(String[] args) {
		...
		data.setEmpiric(479+480+1);
		System.out.println(data.getEmpiricLevel());
	}
